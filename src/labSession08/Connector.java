...
public class Connector {
    ...
    public static ResultSet findPhoneByNumber(Integer number) throws SQLException {
        PreparedStatement stm = cnt.connector.prepareStatement("select * from phone_list where phone_id like ?");
        stm.setInt(1, number);
        return stm.executeQuery();
    }
    ...
    public static ResultSet findPhoneByAccount(String accountName) throws SQLException {
